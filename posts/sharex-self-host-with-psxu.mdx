---
title: Host your own ShareX screenshots with PSXU
date: 'March 25, 2023'
description: Using a webserver as a personal image host to easily use with tools such as ShareX.
tags: ['sharex', 'webserver', 'psxu', 'self-hosted']
---
...
<Section title="downloading and configuring PSXU">
    First, you will need to pick up PSXU from it's <Link href="https://github.com/markski1/PSXU/releases/latest"><span style={{color: 'cyan'}}>Github releases page</span></Link>. Simply download the Source code in ZIP form, and uncompress it in a folder.
...
<Section title="setting up the server">
    ...
    <SyntaxHighlighter customStyle={{fontSize: '.8rem', background: 'black'}}>
        {`
mkdir <dirname>
...
<Section title="setting up Sharex">
    ...
    <img src="../images/blog/psxu/sharex1.png"/>
