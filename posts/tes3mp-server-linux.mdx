...
cd tes3mp
    ...
    Then, proceed to grab the <Link href="https://github.com/TES3MP/TES3MP/releases">latest TES3MP binaries</Link>.
    We will also be using TES3MP's <Link href="https://github.com/TES3MP/CoreScripts">example server management scripts</Link>, which will take care of setting up the state of the server for proper multiplayer.
...
wget https://github.com/TES3MP/CoreScripts/archive/refs/heads/0.8.1.zip
        `}
    </SyntaxHighlighter>

    Once they are downloaded, I'd suggest renaming them to something more friendly (perhaps tes3mp-server.tar.gz and script-files.zip respectively).
    ...
    <SyntaxHighlighter language="bash" customStyle={{fontSize: '.8rem', background: 'black', color: 'white'}}>
        {`
wget https://gist.githubusercontent.com/markski1/c3d63ef32c9c07cbee6da2708f3406e5/raw/c88973e2a86e0c54dfa687cb10c42efe431d44f0/ubuntu_tes3mp_deploy.sh
chmod +x ubuntu_tes3mp_deploy.sh
sudo ./ubuntu_tes3mp_deploy.sh tes3mp-server.tar.gz script-files.zip tes3mp
        `}
    </SyntaxHighlighter>
...
<Section title="settings">
    ...
    Please refer to <Link href="https://steamcommunity.com/groups/mwmulti/discussions/1/133258593388999187/">this steam guide</Link> by TES3MP's lead dev himself, explaining all the things you can and should set up.
