---
title: Monitoring the uptime of your stuff? Easier than you may think!
date: 'October 9, 2023'
description: Once you're running a few hobby projects, you'll want to be the first to know when they fall.
tags: ['monitoring', 'api', 'uptime', 'servers', 'status', 'status page']
order: 40
---
...
<Section title="process">
    ...
    <SyntaxHighlighter language="csharp" customStyle={{fontSize: '.8rem', background: 'black', color: 'white'}}>
{`[HttpGet("CheckAlive")]
...
<Section title="results">
    ...
    2. A nifty little status site at <Link style={{color: 'cyan'}} href="https://status.markski.ar/">status.markski.ar</Link> which, I can't imagine anyone would ever care to check, but hey, why not?
</Section>